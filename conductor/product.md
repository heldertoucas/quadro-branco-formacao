...
- **Ferramenta de Desenho (Ink Overlay):** Camada de desenho livre sobre o quadro com suporte para cores, borracha e sincronização em tempo real entre janelas.

## Estratégia v3.0 (Em Planeamento)
- **Identidade "Glass-Premium":** Evolução do Glassmorphism com grão ultra-subtil e bordas especulares.
- **Cinematografia de Interface:** Transições fluídas (morphing) e animações de texto sequenciais.
